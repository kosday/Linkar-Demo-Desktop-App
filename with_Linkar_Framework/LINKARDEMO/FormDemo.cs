...
namespace LINKARDEMO
{
    public partial class FormDemo : Form
    {
        ...
        private void btnLogin_Click(object sender, EventArgs e)
        {
            ...
            CredentialOptions credentialOptions = new CredentialOptions(host, entrypoint, port, username, password, language, freeText); //NEWFRAMEWORK: Replace CredentialsOptions for CredentialOptions
            //Create LinkarClt client
            this._LinkarClt = new LinkarClient(); //NEWFRAMEWORK: Replace LinkarClt for LinkarClient
            ...
            try
            {
                string lkstring = this._LinkarClt.GetVersion();
